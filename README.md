...
**The engine pin now stands at v0.78.0**, and the largest thing that came with
it is a fourth way of holding a surface. A **subdivision hierarchy** — a cage,
...
| Engine | ClayCore 0.78.0, pinned to the release tag as a submodule |
...
version, because two builds can both say 0.78.0 and differ by a commit. A
