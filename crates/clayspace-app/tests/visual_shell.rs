...
fn state<'a>(
    ...
    ShellState {
        ...
        uv_unavailable: None,
        uv_progress: None,
        bake: clayspace_model::BakeSettings::default(),
        bake_result: None,
        bake_unavailable: None,
        bake_progress: None,
        bake_into: None,
        conform: clayspace_model::ConformSettings::default(),
        conform_outcome: None,
        conform_unavailable: None,
        conform_progress: None,
