...
const PT_BR: Strings = Strings {
    ...
    drag_falloff_names: ["Linear", "Suave", "Suavíssima", "Ampla", "Estreita", "Ombro"],
...
const EN_US: Strings = Strings {
    ...
    drag_falloff_names: ["Linear", "Smooth", "Smoother", "Broad", "Tight", "Shouldered"],
...
const ES_419: Strings = Strings {
    ...
    drag_falloff_names: ["Lineal", "Suave", "Suavísima", "Amplia", "Estrecha", "Hombro"],
    ref_plane_names: ["Frontal", "Lateral", "Superior"],
