...
pub fn home_of(command: &Command) -> Home {
    ...
    match command {
        ...
        SetBrushPressureSize(_) => Home::In("brush", "set_pressure_size"),
        SetBrushPressureStrength(_) => Home::In("brush", "set_pressure_strength"),
        SetBrushPressureCurve(_) => Home::In("brush", "set_pressure_curve"),
