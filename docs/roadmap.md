...
| [#99](https://github.com/CyberdyneCorp/ClayCore/issues/99) armature has one op per item | A negative ZSphere is approximated by a subtractive sphere: the membrane is not cut and the sign is lost on reload | Filed. One field away from expressible |
