...
## Purpose
Which compute backend the engine runs on — how one is discovered, preferred per
platform, overridden and reported — and the invariant underneath all of it: the
backend changes how long an operation takes and never what it produces.
## Requirements
