# surface-settlement Specification

## Purpose
When a released stroke is allowed to settle the surface it touched, and when
settling geometry that was already rebuilt would be work with nothing to
show for it.
## Requirements
