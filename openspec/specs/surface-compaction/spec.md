# surface-compaction Specification

## Purpose
Keeping the duplicate-key structures that triangle pruning builds small and
exact: bounded temporary storage, and hashing that never merges two vertices
that are not the same vertex.
## Requirements
