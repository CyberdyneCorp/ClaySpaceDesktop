...
Withdrawn and restated below as "A live gesture is shown while it is being made, over the whole scene". The rule it carried — that a second
visible field subtool forces the gesture back to being held whole — is reversed
here, not refined: the preview now composes the rest of the scene through the
engine's own union and stays live. Its name said what the old outcome was, so
the requirement is renamed with it.
