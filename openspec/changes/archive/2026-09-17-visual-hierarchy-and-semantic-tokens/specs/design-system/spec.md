...
Withdrawn, and restated below as "The accent marks active state". The old rule
said the accent belongs to the active brush and that a selected layer or scene
entry is never accented; the new one gives the active layer an accent rail. That
reverses a scenario rather than refining it, so it is a removal and an addition
