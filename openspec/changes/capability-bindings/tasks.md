...
- [x] Define `Binding`, `ExecutionFamily` and fidelity in the existing table. (#205)
- [x] Verify declared engine entry points against dispatched calls and the pinned engine. (#202)
- [x] Bind hierarchy smooth modes and its per-pass eraser. (#199, #200)
- [x] Bind signed SDF surface magnify for Inflate and Pinch. (#201)
- [x] Decide each SDF duplicate by a measured distinction or remove its binding with a `ToolNote`: Inflar recalibrated, Camada given its own stamp, Polir and Relaxar withdrawn from the field. Planar previewed and its invert made a deeper cut. (#203, #179)
